(() => {
  var e,
    ...
    i,
    s,
    r = document.getElementById("tbcInvitation"),
  ...
  displayCountdown = function (e) {
    ...
    console.log("Countdown to: ", t); // Log waktu target countdown
    var n = e.querySelector(".countdown > .day > .number"),
    ...
    var i = setInterval(function () {
      ...
      console.log(
        ...
        "Seconds: ",
        seconds
      ); // Log hasil hitung mundur

      if (n) n.innerHTML = days;
      if (o) o.innerHTML = hours;
      if (a) a.innerHTML = minutes;
      if (l) l.innerHTML = seconds;
  ...
  $();
  var ee = document.querySelectorAll(".tbcinvitation_slide"),
    te = document.querySelectorAll(".tbcinvitation_menu_item"),
    ne = document.getElementById("smMenu"),
    oe = document.querySelector(".tbcinvitation_menu_list"),
